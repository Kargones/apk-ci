...
Данный документ описывает интеграцию apk-ci с платформой 1С:Предприятие и использование командных интерфейсов 1cv8.
...
apk-ci анализирует вывод команд 1cv8 для определения успешности операций:
