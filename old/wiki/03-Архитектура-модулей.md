...
Данный документ описывает архитектуру модульной системы benadis-runner, взаимодействие компонентов и паттерны проектирования.

## Общая архитектура

### Принципы Clean Architecture

benadis-runner построен на принципах чистой архитектуры с четким разделением слоев:
