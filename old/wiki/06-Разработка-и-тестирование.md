...
Данный документ содержит инструкции по настройке среды разработки, соглашениям кодирования, процессам тестирования и внесению изменений в проект apk-ci.
    ...
    "configurations": [
        {
            ...
            "request": "launch",
            "mode": "auto",
            "program": "${workspaceFolder}/cmd/apk-ci",
            "env": {
                "BR_COMMAND": "convert",
                "BR_LOG_LEVEL": "Debug"
            },
