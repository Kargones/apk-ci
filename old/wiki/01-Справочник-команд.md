...
Данный документ содержит полное описание всех доступных команд интерфейса командной строки benadis-runner с примерами использования и параметрами.

## Общий синтаксис

```bash
benadis-runner [КОМАНДА] [ОПЦИИ]
```
