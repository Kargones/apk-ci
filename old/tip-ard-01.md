...
Проект `benadis-runner` представляет собой Go-приложение для работы с 1С:Предприятие. После анализа кодовой базы выявлены следующие несоответствия требованиям из `ard-01.md`:
