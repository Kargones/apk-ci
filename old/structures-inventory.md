# Инвентаризация структур данных benadis-runner

## Обзор

Данный документ содержит полную инвентаризацию всех структур данных, найденных в проекте benadis-runner. Структуры сгруппированы по пакетам и функциональному назначению.
