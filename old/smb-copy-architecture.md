...
Данный документ описывает архитектуру функции копирования директорий через SMB/CIFS с аутентификацией Kerberos для системы benadis-runner. Функция `CopyDirectories` предназначена для безопасного и эффективного копирования файлов и директорий между локальной файловой системой и удаленными SMB-ресурсами с использованием Active Directory аутентификации.
