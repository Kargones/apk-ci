...
action_1_dbName: 
    steps:
      ...
      - name: Service Mode Enable DB
        ...
        uses: https://${{ secrets.READER_TOKEN }}:@git.benadis.ru/gitops/apk-ci@${{ inputs.version }}
        with:
