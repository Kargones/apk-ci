...
### Цель доводки
Завершить реализацию интеграции SonarQube в проекте apk-ci, обеспечив полный цикл работы с анализом качества кода: создание проектов, сканирование веток и pull request'ов, синхронизацию репозиториев, генерацию отчетов и управление жизненным циклом проектов в SonarQube.
