# Анализ проекта benadis-runner: Разделение на библиотеки

## Обзор проекта

`benadis-runner` представляет собой монолитное приложение на Go для автоматизации работы с системами 1C:Enterprise. Проект включает в себя модули для конвертации данных, восстановления баз данных, управления сервисным режимом, интеграции с EDT (Enterprise Development Tools) и SonarQube.
...
```
benadis-runner/
├── cmd/benadis-runner/     # Точка входа приложения
├── internal/
...
### 6. Основное приложение-оркестратор: `benadis-runner`

**Описание**: Основное приложение, координирующее работу всех библиотек.

**Компоненты**:
- `cmd/benadis-runner/` - точка входа
