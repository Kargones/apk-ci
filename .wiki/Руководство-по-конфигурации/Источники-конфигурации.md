...
Система конфигурации benadis-runner поддерживает множественные источники конфигурации с четко определенной иерархией приоритетов.
...
const (
    ...
    DefaultRacRetries = 3
    DefaultWorkDir = "/tmp/benadis-runner"
    DefaultTmpDir = "/tmp"
)
```
