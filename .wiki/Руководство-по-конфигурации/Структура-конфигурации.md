...
Система конфигурации apk-ci состоит из нескольких взаимосвязанных структур, каждая из которых отвечает за определенную область настроек.
...
| `WorkDir` | string | Рабочая директория приложения | "/tmp/apk-ci" |
