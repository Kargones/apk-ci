...
Система конфигурации apk-ci обеспечивает централизованное управление настройками с поддержкой множественных источников конфигурации и определенным порядком приоритетов.
