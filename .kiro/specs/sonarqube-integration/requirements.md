...
Данный документ описывает требования для реализации интеграции с SonarQube в проекте benadis-runner. Интеграция должна обеспечить полный цикл работы с анализом качества кода: создание проектов, сканирование веток и pull request'ов, синхронизацию репозиториев, генерацию отчетов и управление жизненным циклом проектов в SonarQube.
