...
`benadis-runner` — инструмент автоматизации для систем 1C:Enterprise, предназначенный для:
...
- `cmd/benadis-runner/main.go` - точка входа, маршрутизатор команд
