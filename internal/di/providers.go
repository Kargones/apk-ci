...
//
// TODO (M2/Review 6-2): Рефакторинг — объединить config.AlertingConfig и alerting.Config
...
//
// TODO (H-3/Review Epic-6): Alerter инициализируется через DI, но НЕ интегрирован
