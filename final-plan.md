...
### Цель доводки
Завершить реализацию интеграции с SonarQube в проекте benadis-runner, обеспечив полный жизненный цикл работы с анализом качества кода: создание проектов, сканирование веток и pull request'ов, синхронизацию репозиториев, генерацию отчетов и управление проектами в SonarQube.
...
- `cmd/benadis-runner/main.go` - интеграция команд в основное приложение
